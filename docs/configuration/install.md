...
1. [Systemanforderungen](#system-requirements)
   1. [Hardware](#hardware)
   1. [Empfohlene Konfiguration](#recommended-setup-for-running-ilias)
   1. [Empfohlene Datenbank-Konfiguration](#database-recommendations)
   1. [Referenz-System](#reference-system)
   1. [Andere Plattformen und Integrationen](#other-platforms)
1. [Installation auf Ubuntu 20.04](#manual-installation-on-linux)
   1. [Grundlegende Installation](#install-dependencies)
      1. [Apache](#apache-installation)
      1. [PHP](#php-installation)
      1. [MySQL/MariaDB](#database-installation)
         1. [MySQL Strict Mode \(5.6+\)](#mysql-strict-mode-56)
         1. [MySQL Performance Tuning \(optional\)](#mysql-performance-tuning-optional)
         1. [Optionale Module](#optional-modules)
   1. [ILIAS installieren](#get-code)
   1. [Zusätzliche Sicherheits-Einstellungen](#hardening-and-security)
   1. [Konfiguration ILIAS Java RPC Server \(optional\)](#java-rpc-configuration)
   1. [Konfiguration E-Mail-Server \(optional\)](#e-mail-configuration)
   1. [Konfiguration WebDAV \(optional\)](#webdav-configuration)
      1. [WebDAV mit Windows Explorer \)](#webdav-windows-explorer)
      1. [WebDAV mit Mac Finder\)](#webdav-mac-finder)
   1. [Plugins (optional)](#install-plugins-and-styles)
1. [ILIAS anpassen](#customizing-ilias)
